...
// $insert polymorphicSpecializations
    ...
    struct TagOf<oper1*>
    {
        static Tag__ const tag = Tag__::Opr;
    };

    template <>
    struct TagOf<stmt_ast*>
    {
        static Tag__ const tag = Tag__::stmt_ast;
    };

    template <>
    struct TagOf<exp_ast*>
    {
        static Tag__ const tag = Tag__::exp_ast;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::Opr>
    {
        typedef oper1* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::stmt_ast>
    {
        typedef stmt_ast* DataType;
    };

    template <>
    struct TypeOfBase<Tag__::exp_ast>
    {
        typedef exp_ast* DataType;
    };
